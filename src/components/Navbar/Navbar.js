  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 '>
        ...
        <div className='flex'>
          ...
          <NavButton title='Chat' dotColor="#04C9D7" customFunc={
            ()=>{handleClick('chat')}
        ...
        <TooltipComponent content="profile" position='BottomCenter'>
            <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={()=>{}}>
              ...
              <p>
                <span className='text-gray-400 text-14'>Hi, </span>{' '}<span className='text-gray-400 font-bold ml-1 text-14'>Micheal</span>
              </p>
